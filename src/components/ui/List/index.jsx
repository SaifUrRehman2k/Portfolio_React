        ...
        <li key={data.email} className="flex justify-between py-5 h-32">
            <div className="flex min-w-0 gap-x-4">
                ...
                <div className="min-w-0 flex flex-col">
                    <h4 className="text-gray-100 m-0">{data.name}</h4>
                    <p className="mt-1 truncate text-gray-100">{data.email}</p>
                </div>
            </div>
            <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                <h4 className="text-gray-100 m-0">{data.role}</h4>
                {data.lastSeen ? (
                    <span className="mt-1 text-xs/5 text-gray-100">
