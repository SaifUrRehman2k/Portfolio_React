...
const Hero = () => {
    return (
        <section className="w-full flex items-center justify-center">
            {/* Main Flex Container */}
            <div className="w-full max-w-6xl flex flex-col-reverse md:flex-row items-center justify-between gap-8">
                ...
                <div className="flex-1 flex items-center justify-center max-w-64 max-h-64 ">
                    <div className="border-4 border-black relative max-w-64 max-h-64 w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 rounded-full p-1 bg-linear-to-tr from-blue-500 to-purple-500">
                        <img
                            alt="Profile"
